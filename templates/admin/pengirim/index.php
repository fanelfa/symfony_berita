...
<body>
    ...
    <div id="wrapper">
            ...
            <div class="sidebar-scroll">
                <nav>
                    <ul class="nav">
                        ...
                        <li><a href="<?php echo base_url() ?>admin/pengirim" class="active"><i class="lnr lnr-user"></i> <span>Pengirim</span></a></li>
        ...
        <div class="main">
            ...
            <div class="main-content">
                <div class="container-fluid">
                    <h3 class="page-title">Admin Pengirim</h3>
                    <div class="row">
                        <div class="col-md-10">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel">
                                <div class="panel-heading">
                                    <h3 class="panel-title">List Pengirim</h3>
                                </div>
                                        ...
                                        <tbody>
                                            <?php foreach ($pengirim as $key => $value) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button id="btn-edit" type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#editModal" data-id="<?php echo $value->id; ?>" data-nama="<?php echo $value->nama; ?>" data-bio="<?php echo $value->bio; ?>">
                                                            Edit
                                                        </button>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form class="modal-form" action="<?php echo base_url(); ?>admin/pengirim/store" method="post">
                    <div class="modal-body">
                        <input type="text" class="form-control" name="nama" placeholder="Nama" required>
                        <br>
                        <textarea class="form-control" name="bio" id="bio" placeholder="Bio Pengirim" required></textarea>
                        <br>
                    </div>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form class="modal-form" action="<?php echo base_url(); ?>admin/pengirim/update/1" method="post" enctype="">
                    <div class="modal-body">
                        ...
                        <br>
                        <textarea class="form-control" value="" name="bio" id="bio" placeholder="Bio Pengirim" required></textarea>
                        <br>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                <form class="modal-form" action="<?php echo base_url(); ?>admin/pengirim/delete/1" method="post">
                    <div class="modal-header">
    ...
    <script>
        $(document).on("click", "#btn-edit", function() {
            ...
            $("#editModal .modal-body textarea[name='bio']").val(bio);
        });
